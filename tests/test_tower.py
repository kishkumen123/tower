...
class TestGame(unittest.TestCase):
    ...
    def test_undo_move_success(self):
        ...
        self.assertEqual(self.default_game["move_buffer_size"], response.json["move_buffer_size"])
    ...
    def test_move_buffer(self):
        ...
        response = self.app.patch("http://127.0.0.1:5000/move", json={"id": 1, "src": 2, "dst": 3})
        response = self.app.patch("http://127.0.0.1:5000/move", json={"id": 1, "src": 1, "dst": 2})
        response = self.app.patch("http://127.0.0.1:5000/move", json={"id": 1, "src": 3, "dst": 1})
    ...
    def test_solved_third_pillar(self):
        ...
        response = self.app.patch("http://127.0.0.1:5000/move", json={"id": 1, "src": 1, "dst": 3})
        response = self.app.patch("http://127.0.0.1:5000/move", json={"id": 1, "src": 2, "dst": 3})
        response = self.app.patch("http://127.0.0.1:5000/move", json={"id": 1, "src": 2, "dst": 1})
        response = self.app.patch("http://127.0.0.1:5000/move", json={"id": 1, "src": 3, "dst": 1})
        response = self.app.patch("http://127.0.0.1:5000/move", json={"id": 1, "src": 2, "dst": 3})
        response = self.app.patch("http://127.0.0.1:5000/move", json={"id": 1, "src": 1, "dst": 2})
        response = self.app.patch("http://127.0.0.1:5000/move", json={"id": 1, "src": 1, "dst": 3})
